...
var this__25439__auto__ = this;
React.Component.apply(this__25439__auto__,arguments);

if(!((this__25439__auto__.initLocalState == null))){
this__25439__auto__.state = this__25439__auto__.initLocalState();
} else {
this__25439__auto__.state = {};
}

return this__25439__auto__;
});

kitchensink.core.Root.prototype = goog.object.clone(React.Component.prototype);

var x28090_28102 = kitchensink.core.Root.prototype;
x28090_28102.componentWillUpdate = ((function (x28090_28102){
return (function (next_props__25294__auto__,next_state__25295__auto__){
var this__25293__auto__ = this;
if(((!((this__25293__auto__ == null)))?(((false) || (this__25293__auto__.om$next$Ident$))?true:false):false)){
var ident__25297__auto___28103 = om.next.ident.call(null,this__25293__auto__,om.next.props.call(null,this__25293__auto__));
var next_ident__25298__auto___28104 = om.next.ident.call(null,this__25293__auto__,om.next._next_props.call(null,next_props__25294__auto__,this__25293__auto__));
if(cljs.core.not_EQ_.call(null,ident__25297__auto___28103,next_ident__25298__auto___28104)){
var idxr__25299__auto___28105 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__25293__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__25299__auto___28105 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__25299__auto___28105),((function (idxr__25299__auto___28105,ident__25297__auto___28103,next_ident__25298__auto___28104,this__25293__auto__,x28090_28102){
return (function (indexes__25300__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__25300__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__25297__auto___28103], null),cljs.core.disj,this__25293__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__25298__auto___28104], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__25293__auto__);
});})(idxr__25299__auto___28105,ident__25297__auto___28103,next_ident__25298__auto___28104,this__25293__auto__,x28090_28102))
);
}
} else {
}
...
om.next.merge_pending_props_BANG_.call(null,this__25293__auto__);

return om.next.merge_pending_state_BANG_.call(null,this__25293__auto__);
});})(x28090_28102))
;

x28090_28102.shouldComponentUpdate = ((function (x28090_28102){
return (function (next_props__25294__auto__,next_state__25295__auto__){
var this__25293__auto__ = this;
var next_children__25296__auto__ = next_props__25294__auto__.children;
var next_props__25294__auto____$1 = goog.object.get(next_props__25294__auto__,"omcljs$value");
var next_props__25294__auto____$2 = (function (){var G__28092 = next_props__25294__auto____$1;
if((next_props__25294__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__28092);
} else {
return G__28092;
}
})();
var or__20097__auto__ = cljs.core.not_EQ_.call(null,om.next.props.call(null,this__25293__auto__),next_props__25294__auto____$2);
if(or__20097__auto__){
return or__20097__auto__;
} else {
var or__20097__auto____$1 = (function (){var and__20085__auto__ = this__25293__auto__.state;
if(cljs.core.truth_(and__20085__auto__)){
return cljs.core.not_EQ_.call(null,goog.object.get(this__25293__auto__.state,"omcljs$state"),goog.object.get(next_state__25295__auto__,"omcljs$state"));
} else {
...
return cljs.core.not_EQ_.call(null,this__25293__auto__.props.children,next_children__25296__auto__);
}
}
});})(x28090_28102))
;

x28090_28102.componentWillUnmount = ((function (x28090_28102){
return (function (){
var this__25293__auto__ = this;
var r__25304__auto__ = om.next.get_reconciler.call(null,this__25293__auto__);
var cfg__25305__auto__ = new cljs.core.Keyword(null,"config","config",994861415).cljs$core$IFn$_invoke$arity$1(r__25304__auto__);
var st__25306__auto__ = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cfg__25305__auto__);
var indexer__25303__auto__ = new cljs.core.Keyword(null,"indexer","indexer",-1774914315).cljs$core$IFn$_invoke$arity$1(cfg__25305__auto__);
if(cljs.core.truth_((function (){var and__20085__auto__ = !((st__25306__auto__ == null));
if(and__20085__auto__){
return cljs.core.get_in.call(null,cljs.core.deref.call(null,st__25306__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("om.next","queries","om.next/queries",-22717146),this__25293__auto__], null));
} else {
return and__20085__auto__;
}
})())){
cljs.core.swap_BANG_.call(null,st__25306__auto__,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("om.next","queries","om.next/queries",-22717146)], null),cljs.core.dissoc,this__25293__auto__);
} else {
}

if((indexer__25303__auto__ == null)){
return null;
} else {
return om.next.protocols.drop_component_BANG_.call(null,indexer__25303__auto__,this__25293__auto__);
}
});})(x28090_28102))
;

x28090_28102.componentDidUpdate = ((function (x28090_28102){
return (function (prev_props__25301__auto__,prev_state__25302__auto__){
var this__25293__auto__ = this;
return om.next.clear_prev_props_BANG_.call(null,this__25293__auto__);
});})(x28090_28102))
;

x28090_28102.isMounted = ((function (x28090_28102){
return (function (){
var this__25293__auto__ = this;
return cljs.core.boolean$.call(null,goog.object.getValueByKeys(this__25293__auto__,"_reactInternalInstance","_renderedComponent"));
});})(x28090_28102))
;

x28090_28102.componentWillMount = ((function (x28090_28102){
return (function (){
var this__25293__auto__ = this;
var indexer__25303__auto__ = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__25293__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((indexer__25303__auto__ == null)){
return null;
} else {
return om.next.protocols.index_component_BANG_.call(null,indexer__25303__auto__,this__25293__auto__);
}
});})(x28090_28102))
;

x28090_28102.initLocalState = ((function (x28090_28102){
return (function (){
var this$ = this;
var ret__25271__auto__ = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"collapse","collapse",-1218136136),true,new cljs.core.Keyword(null,"slider","slider",-472668865),(8),new cljs.core.Keyword(null,"text","text",-1790561697),"This looks like text but can be edited",new cljs.core.Keyword(null,"radio","radio",1323726374),"slaw"], null);
var obj28094 = {"omcljs$state":ret__25271__auto__};
return obj28094;
});})(x28090_28102))
;

x28090_28102.render = ((function (x28090_28102){
return (function (){
var this__25292__auto__ = this;
var this$ = this__25292__auto__;
var _STAR_reconciler_STAR_28095 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_28096 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_28097 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_28098 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_28099 = om.next._STAR_parent_STAR_;
om.next._STAR_reconciler_STAR_ = om.next.get_reconciler.call(null,this__25292__auto__);

om.next._STAR_depth_STAR_ = (om.next.depth.call(null,this__25292__auto__) + (1));

om.next._STAR_shared_STAR_ = om.next.shared.call(null,this__25292__auto__);

om.next._STAR_instrument_STAR_ = om.next.instrument.call(null,this__25292__auto__);

om.next._STAR_parent_STAR_ = this__25292__auto__;

try{var toggle = ((function (_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102){
return (function (key){
return ((function (_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102){
return (function (){
return om.next.update_state_BANG_.call(null,this$,cljs.core.update,key,cljs.core.not);
});
;})(_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102))
});})(_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102))
;
var enabled_QMARK_ = ((function (toggle,_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102){
return (function (key){
return om.next.get_state.call(null,this$).call(null,key);
});})(toggle,_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102))
;
var section = ((function (toggle,enabled_QMARK_,_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102){
return (function() { 
...
], null)),blueprint_cljs.core.collapsible_list.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"pt-breadcrumbs",new cljs.core.Keyword(null,"visible-item-count","visible-item-count",1159233092),new cljs.core.Keyword(null,"slider","slider",-472668865).cljs$core$IFn$_invoke$arity$1(om.next.get_state.call(null,this$)),new cljs.core.Keyword(null,"dropdown-target","dropdown-target",-1369792600),React.DOM.span(({"className": "pt-breadcrumbs-collapsed"})),new cljs.core.Keyword(null,"render-visible-item","render-visible-item",-1136751532),((function (toggle,enabled_QMARK_,section,_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102){
...
], null),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"These"], null)),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"Words"], null)),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"Can"], null)),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"Be"], null)),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"Removed"], null)),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"With"], null)),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"The"], null)),blueprint_cljs.core.menu_item.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"Slider"], null)))),section.call(null,React.DOM.div(null,"This is just text"),om_tools.dom.element.call(null,React.DOM.div,blueprint_cljs.core.editable_text.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (toggle,enabled_QMARK_,section,_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102){
return (function (s){
return om.next.update_state_BANG_.call(null,this$,cljs.core.assoc,new cljs.core.Keyword(null,"text","text",-1790561697),s);
});})(toggle,enabled_QMARK_,section,_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102))
,new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"text","text",-1790561697).cljs$core$IFn$_invoke$arity$1(om.next.get_state.call(null,this$))], null)),cljs.core.PersistentVector.EMPTY),React.DOM.div(null,"This is just text")),section.call(null,blueprint_cljs.core.checkbox.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"checked","checked",-50955819),enabled_QMARK_.call(null,new cljs.core.Keyword(null,"checkbox","checkbox",1612615655)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),toggle.call(null,new cljs.core.Keyword(null,"checkbox","checkbox",1612615655))], null),"Checkbox")),section.call(null,blueprint_cljs.core.radio_group.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (toggle,enabled_QMARK_,section,_STAR_reconciler_STAR_28095,_STAR_depth_STAR_28096,_STAR_shared_STAR_28097,_STAR_instrument_STAR_28098,_STAR_parent_STAR_28099,this$,this__25292__auto__,x28090_28102){
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_28099;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_28098;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_28097;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_28096;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_28095;
}});})(x28090_28102))
;
...
var x28100_28109 = kitchensink.core.Root;


var x28101_28110 = kitchensink.core.Root.prototype;
...
kitchensink.core.Root.cljs$lang$ctorPrWriter = (function (this__25442__auto__,writer__25443__auto__,opt__25444__auto__){
return cljs.core._write.call(null,writer__25443__auto__,"kitchensink.core/Root");
});
